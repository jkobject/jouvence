...
def export_human_organism_slice(input_root: str | Path, output_root: str | Path) -> HumanOrganismExportSummary:
    ...
    ``input_root`` supplies the current canonical gene/tissue node IDs.
    ...
    gene_nodes = kg_storage.read_nodes(source, "gene", columns=["id"])
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("input_root", help="KG root containing canonical gene/tissue nodes")
