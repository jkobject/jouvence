...
def parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--node-root", default=".omoc/gcs-cache/kg-v2/nodes")
    p.add_argument("--cell-line-nodes", default=".omoc/gcs-cache/kg-v2/nodes/cell_line.parquet")
    p.add_argument("--gene-nodes", default=".omoc/gcs-cache/kg-v2/nodes/gene.parquet")
    p.add_argument("--protein-nodes", default=".omoc/gcs-cache/kg-v2/nodes/protein.parquet")
    p.add_argument("--molecule-nodes", default=".omoc/gcs-cache/kg-v2/nodes/molecule.parquet")
    p.add_argument("--model", default=".omoc/raw/cell_line_assays/downloads/Model.csv")
    p.add_argument("--crispr-dependency", default=".omoc/raw/cell_line_assays/downloads/CRISPRGeneDependency.csv")
    p.add_argument("--gdsc-dose-response", default=".omoc/raw/cell_line_assays/downloads/sanger-dose-response.csv")
    p.add_argument("--proteomics", default=".omoc/raw/cell_line_assays/downloads/harmonized_MS_CCLE_Gygi.csv")
    p.add_argument("--uniprot-mapping", default=".omoc/raw/cell_line_assays/downloads/uniprot_hugo_entrez_id_mapping.csv")
    p.add_argument("--source-manifest", default=".omoc/raw/cell_line_assays/downloads/manifest.json")
