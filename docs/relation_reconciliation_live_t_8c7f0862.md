...
- Ledger SHA256: `4d3f54286530f499a0c758e67526f3075b407143ff01636d1a5f8c179f9d5d5d`
- Exact GCS inventory bundle: `.omoc/reports/relation_reconciliation_live_t_8c7f0862_gcs_inventory.json`
- Inventory bundle SHA256: `95e4f2e3b6de3f3c5c323a3f49928ce9c08bd69959213d9f9e0973325cfc631b`

## Executive result

The active-schema denominator reconciles exactly once: **67 relations**. Direct GCS readback has **41 canonical active edge relations**, **20 with evidence**, **21 without evidence**, and **101,744,668 canonical edge rows**. The previous 40/18/22/100,080,390 snapshot is stale.
...
| Canonical active relations | 40 | 41 |
| Canonical with evidence | 18 | 20 |
| Canonical without evidence | 22 | 21 |
| Declared not canonical | 27 | 26 |
| Canonical edge rows | 100,080,390 | 101,744,668 |
| Review-required | 3 | 4 |

Next-state partition (sum must equal 67):

- `accepted-canonical`: **30**
- `deferred-policy`: **3**
- `evidence-backfill-candidate`: **5**
- `feature-context`: **9**
- `promote-candidate`: **10**
- `rejected`: **1**
- `review-required`: **4**
- `schema-missing`: **5**
...
| `mutation_in_gene` | `mutation→gene` | true | 2,599,525/2,599,525/2,599,525 | 1580388/1580388 | gaps 0/0; endpoint reported-zero-on-current-promoted-artifact | `canonical+review-required` | `review-required` |
...
| `mutation_overlaps_enhancer` | `mutation→enhancer` | false | 1,664,278/1,664,278/– | 3335215/3335215 | gaps 0/0; endpoint reported-zero-on-current-promoted-artifact | `canonical+review-required` | `review-required` |
...
| `tf_binds_enhancer` | `gene→enhancer` | true | –/–/– | 189459767/189459767 | gaps None/None; endpoint not-applicable-no-accepted-edge-candidate | `noncanonical+policy-deferred` | `deferred-policy` |
...
| `disease_associated_protein` | `protein→disease` | true | –/–/– | 3243/35839 | gaps 0/0; endpoint pass | `staged+validated-promote-candidate` | `promote-candidate` |
...
| `disease_manifests_in_tissue` | `disease→tissue` | false | 19/29/– | –/– | gaps 0/0; endpoint reported-zero-on-current-promoted-artifact | `canonical+review-required` | `review-required` |
...
| `gs://jouvencekb/kg/v2/staging/disease-associated-protein-20260622-t_7f0cccde/` | 8 | 3 | `da093217dcbe4855b358c0b6e53f051bdd4d148f8b6706e1394e68d2ec5c3c5d` | `disease_associated_protein` | route to protein-native promote-candidate review |
...
uv run python scripts/build_live_relation_reconciliation.py --inventory-dir artifacts/cache/t_8c7f0862/live_inventory --captured-at 2026-07-22T13:10:01Z --schema-commit 034e498abb54d6d98e1b2b86f4a50b2b51f893f5 --json-output .omoc/reports/relation_reconciliation_live_t_8c7f0862.json --markdown-output docs/relation_reconciliation_live_t_8c7f0862.md --inventory-output .omoc/reports/relation_reconciliation_live_t_8c7f0862_gcs_inventory.json
