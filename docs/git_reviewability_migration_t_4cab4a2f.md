...
- Local reviewable work location: `/Users/jkobject/.openclaw/worktrees/txgnn/<branch-or-task-id>/`
- Current `/Users/jkobject/.openclaw/workspace/work/txgnn` remains a shared artifact workspace until migration is complete. Do not claim PR-ready diffs from it.
...
git add CLAUDE.md TODO.md todo.d docs manage_db scripts tests pyproject.toml uv.lock README.md REPORT.md .gitignore
...
3. PR diff includes current boot/process docs: `CLAUDE.md`, `TODO.md`, `todo.d/`, and relevant `docs/` reports.
