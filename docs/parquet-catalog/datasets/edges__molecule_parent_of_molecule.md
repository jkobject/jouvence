...
- As of: `2026-06-18`
- Canonical URI/pattern: `gs://jouvencekb/kg/v2/edges/molecule_parent_of_molecule.parquet`
- Logical rows: **4,140**
- Physical objects: **1**
- Bytes: **19,797**
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/kg/v2/edges/molecule_parent_of_molecule.parquet` | 4,140 | 19,797 | `1781796942923766` | `lBYRsQ==` | `OEqS3FWlGG5lPX3u0wNUow==` |
...
LOCAL_DIR='./parquet-catalog-data/edges__molecule_parent_of_molecule'
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/molecule_parent_of_molecule.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/kg/v2/edges/molecule_parent_of_molecule.parquet'))
...
SELECT "x_id" FROM read_parquet('./parquet-catalog-data/edges__molecule_parent_of_molecule/molecule_parent_of_molecule.parquet') ORDER BY "x_id" NULLS LAST LIMIT 5;
```
