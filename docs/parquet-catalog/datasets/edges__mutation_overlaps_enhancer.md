...
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/mutation_overlaps_enhancer.parquet' ./
```
...
paths = fs.glob('jouvencekb/kg/v2/edges/mutation_overlaps_enhancer.parquet')
