...
- As of: `2026-06-15`
- Canonical URI/pattern: `gs://jouvencekb/kg/v2/nodes/enhancer.parquet`
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/kg/v2/nodes/enhancer.parquet` | 48,808,144 | 3,404,993,079 | `1781481603774953` | `wYXovg==` | `AM0+bRM0dLsnMu+o5ADVbg==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/nodes/enhancer.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/kg/v2/nodes/enhancer.parquet'))
