...
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/molecule_treats_disease.parquet' ./
```
...
paths = fs.glob('jouvencekb/kg/v2/edges/molecule_treats_disease.parquet')
