...
# `edges__cell_type_expresses_gene`

- Layer: `edges`
- Status: **canonical present**
- As of: `2026-06-11`
- Canonical URI/pattern: `gs://jouvencekb/kg/v2/edges/cell_type_expresses_gene.parquet`
- Logical rows: **1,561,873**
- Physical objects: **1**
- Bytes: **6,532,333**
- Schema hash (`arrow-fields-v1`): `55de19336a48d53e1108734aeb431d3ad8cc602391781c594cd9d0c89ecfa364`
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/kg/v2/edges/cell_type_expresses_gene.parquet` | 1,561,873 | 6,532,333 | `1781177661088086` | `7dWZWg==` | `39oktc2xzF//JLMYYhisvA==` |
...
LOCAL_DIR='./parquet-catalog-data/edges__cell_type_expresses_gene'
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/cell_type_expresses_gene.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/kg/v2/edges/cell_type_expresses_gene.parquet'))
...
SELECT "x_id" FROM read_parquet('./parquet-catalog-data/edges__cell_type_expresses_gene/cell_type_expresses_gene.parquet') ORDER BY "x_id" NULLS LAST LIMIT 5;
```
