...
- As of: `2026-06-14`
- Canonical URI/pattern: `gs://jouvencekb/kg/v2/nodes/cell_line.parquet`
- Logical rows: **1,183**
- Physical objects: **1**
- Bytes: **31,819**
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/kg/v2/nodes/cell_line.parquet` | 1,183 | 31,819 | `1781481541246158` | `5qNrqA==` | `C+jyEaOC/ZMeXVAzMw2vmA==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/nodes/cell_line.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/kg/v2/nodes/cell_line.parquet'))
