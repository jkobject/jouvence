...
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/tissue_subtype_of_tissue.parquet' ./
```
...
paths = fs.glob('jouvencekb/kg/v2/edges/tissue_subtype_of_tissue.parquet')
