...
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/cell_line_expresses_gene.parquet' ./
```
...
paths = fs.glob('jouvencekb/kg/v2/edges/cell_line_expresses_gene.parquet')
