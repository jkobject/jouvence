...
SELECT "edge_key" FROM read_parquet('./parquet-catalog-data/evidence__molecule_targets_gene/molecule_targets_gene.parquet') ORDER BY "edge_key" NULLS LAST LIMIT 5;
```
