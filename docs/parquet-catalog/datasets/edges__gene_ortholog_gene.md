...
- Physical objects: **1**
- Bytes: **3,076,768**
- Schema hash (`arrow-fields-v1`): `c4f6301b53d5fa75e4765f8795cab15d62a99122d40248b3f28e72c8a198e898`
...
| `homology_type` | `large_string` | `true` |
| `species_id` | `large_string` | `true` |
| `species_name` | `large_string` | `true` |
| `is_high_confidence` | `bool` | `true` |
| `query_percentage_identity` | `double` | `true` |
| `target_percentage_identity` | `double` | `true` |
...
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/gene_ortholog_gene.parquet' ./
```
...
paths = fs.glob('jouvencekb/kg/v2/edges/gene_ortholog_gene.parquet')
