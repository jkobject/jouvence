...
- As of: `2026-06-15`
- Canonical URI/pattern: `gs://jouvencekb/kg/v2/edges/cell_line_derived_from_tissue.parquet`
- Logical rows: **1,092**
- Physical objects: **1**
- Bytes: **13,643**
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/kg/v2/edges/cell_line_derived_from_tissue.parquet` | 1,092 | 13,643 | `1781481604582972` | `fCahxA==` | `Fs2EVfeAmngteaR12zjKsw==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/cell_line_derived_from_tissue.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/kg/v2/edges/cell_line_derived_from_tissue.parquet'))
