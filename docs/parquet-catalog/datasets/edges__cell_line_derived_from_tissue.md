...
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/cell_line_derived_from_tissue.parquet' ./
```
...
paths = fs.glob('jouvencekb/kg/v2/edges/cell_line_derived_from_tissue.parquet')
