...
SELECT "feature_key" FROM read_parquet('./parquet-catalog-data/features__cell_line_textual_summary/cell_line_textual_summary.parquet') ORDER BY "feature_key" NULLS LAST LIMIT 5;
```
