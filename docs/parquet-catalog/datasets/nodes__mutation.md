...
- As of: `2026-06-10`
- Canonical URI/pattern: `gs://jouvencekb/kg/v2/nodes/mutation.parquet`
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/kg/v2/nodes/mutation.parquet` | 2,589,509 | 89,685,283 | `1781115241845253` | `Ka/IoA==` | `IlXuascsr6lsWOT7OUcdoA==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/nodes/mutation.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/kg/v2/nodes/mutation.parquet'))
