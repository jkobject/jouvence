...
- As of: `2026-06-24`
- Canonical URI/pattern: `gs://jouvencekb/kg/v2/edges/disease_manifests_in_tissue.parquet`
- Logical rows: **19**
- Physical objects: **1**
- Bytes: **5,416**
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/kg/v2/edges/disease_manifests_in_tissue.parquet` | 19 | 5,416 | `1782325469191009` | `u8X16w==` | `InWrVFw5VmnbbQJ1DGbeSQ==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/disease_manifests_in_tissue.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/kg/v2/edges/disease_manifests_in_tissue.parquet'))
