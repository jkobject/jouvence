...
- As of: `2026-06-18`
- Canonical URI/pattern: `gs://jouvencekb/kg/v2/edges/molecule_targets_gene.parquet`
- Logical rows: **41,239**
- Physical objects: **1**
- Bytes: **238,792**
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/kg/v2/edges/molecule_targets_gene.parquet` | 41,239 | 238,792 | `1781796932474539` | `D5jLtA==` | `1MKTWfaX8LiHeQa3Xuxhtg==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/molecule_targets_gene.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/kg/v2/edges/molecule_targets_gene.parquet'))
