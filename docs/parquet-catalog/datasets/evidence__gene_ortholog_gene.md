...
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/evidence/gene_ortholog_gene.parquet' ./
```
...
paths = fs.glob('jouvencekb/kg/v2/evidence/gene_ortholog_gene.parquet')
