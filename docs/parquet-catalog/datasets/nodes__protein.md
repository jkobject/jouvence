...
- As of: `2026-06-09`
- Canonical URI/pattern: `gs://jouvencekb/kg/v2/nodes/protein.parquet`
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/kg/v2/nodes/protein.parquet` | 233,995 | 4,121,076 | `1781017349893351` | `ZJjYGA==` | `l9jzgVfnLERaIq8qtS9qRg==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/nodes/protein.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/kg/v2/nodes/protein.parquet'))
