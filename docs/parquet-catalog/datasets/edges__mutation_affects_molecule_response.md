...
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/mutation_affects_molecule_response.parquet' ./
```
...
paths = fs.glob('jouvencekb/kg/v2/edges/mutation_affects_molecule_response.parquet')
