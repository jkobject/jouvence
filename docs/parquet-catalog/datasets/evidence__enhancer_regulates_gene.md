...
SELECT "edge_key" FROM read_parquet('./parquet-catalog-data/evidence__enhancer_regulates_gene/enhancer_regulates_gene.parquet') ORDER BY "edge_key" NULLS LAST LIMIT 5;
```
