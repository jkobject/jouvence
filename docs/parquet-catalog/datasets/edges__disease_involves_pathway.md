...
# `edges__disease_involves_pathway`

- Layer: `edges`
- Status: **canonical present**
- As of: `2026-06-19`
- Canonical URI/pattern: `gs://jouvencekb/kg/v2/edges/disease_involves_pathway.parquet`
- Logical rows: **2,296**
- Physical objects: **1**
- Bytes: **69,329**
- Schema hash (`arrow-fields-v1`): `0dc6911b08f5dc26f659c28f94ab8db265f64a672ff7d2255e0dd9a74eac9c17`
...
| `score` | `double` | `true` |
| `pathway_name` | `large_string` | `true` |
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/kg/v2/edges/disease_involves_pathway.parquet` | 2,296 | 69,329 | `1781862038597418` | `u1qK6A==` | `hJGj23LA425r+jDG+BUZxg==` |
...
LOCAL_DIR='./parquet-catalog-data/edges__disease_involves_pathway'
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/disease_involves_pathway.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/kg/v2/edges/disease_involves_pathway.parquet'))
...
SELECT "x_id" FROM read_parquet('./parquet-catalog-data/edges__disease_involves_pathway/disease_involves_pathway.parquet') ORDER BY "x_id" NULLS LAST LIMIT 5;
```
