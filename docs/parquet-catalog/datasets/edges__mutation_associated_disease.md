...
SELECT "x_id" FROM read_parquet('./parquet-catalog-data/edges__mutation_associated_disease/mutation_associated_disease.parquet') ORDER BY "x_id" NULLS LAST LIMIT 5;
```
