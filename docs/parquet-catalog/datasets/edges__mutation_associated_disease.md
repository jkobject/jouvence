...
# `edges__mutation_associated_disease`
...
- Physical objects: **1**
- Bytes: **89,034,605**
- Schema hash (`arrow-fields-v1`): `0e2d3dd1958960bac40344ecb41b055465417e6869cf940e1fc72c0dc9aea513`
...
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/mutation_associated_disease.parquet' ./
```
...
paths = fs.glob('jouvencekb/kg/v2/edges/mutation_associated_disease.parquet')
