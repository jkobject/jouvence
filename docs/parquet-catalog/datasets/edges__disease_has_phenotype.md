...
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/disease_has_phenotype.parquet' ./
```
...
paths = fs.glob('jouvencekb/kg/v2/edges/disease_has_phenotype.parquet')
