...
# `edges__tissue_expresses_gene`

- Layer: `edges`
- Status: **canonical present**
- As of: `2026-06-18`
- Canonical URI/pattern: `gs://jouvencekb/kg/v2/edges/tissue_expresses_gene.parquet`
- Logical rows: **5,338,736**
- Physical objects: **1**
- Bytes: **41,362,747**
- Schema hash (`arrow-fields-v1`): `145011ad67eba82a0e51e34b197b573edea387d056056d12af46675f8ae32b0f`
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/kg/v2/edges/tissue_expresses_gene.parquet` | 5,338,736 | 41,362,747 | `1781796940864266` | `H22BCQ==` | `Z20jxG/HwBkMNYi/GDdZzw==` |
...
LOCAL_DIR='./parquet-catalog-data/edges__tissue_expresses_gene'
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/tissue_expresses_gene.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/kg/v2/edges/tissue_expresses_gene.parquet'))
...
SELECT "x_id" FROM read_parquet('./parquet-catalog-data/edges__tissue_expresses_gene/tissue_expresses_gene.parquet') ORDER BY "x_id" NULLS LAST LIMIT 5;
```
