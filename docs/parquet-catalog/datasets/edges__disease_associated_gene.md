...
# `edges__disease_associated_gene`

- Layer: `edges`
- Status: **canonical present**
- As of: `2026-06-19`
- Canonical URI/pattern: `gs://jouvencekb/kg/v2/edges/disease_associated_gene.parquet`
- Logical rows: **83,339**
- Physical objects: **1**
- Bytes: **314,067**
- Schema hash (`arrow-fields-v1`): `35fa300d9883a453a33684ed2798242febf297771190efa79b0f0a08f5ea6b1a`
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/kg/v2/edges/disease_associated_gene.parquet` | 83,339 | 314,067 | `1781862037334855` | `BeQhmg==` | `7FWBVKWpVNDyRY0Z5knChA==` |
