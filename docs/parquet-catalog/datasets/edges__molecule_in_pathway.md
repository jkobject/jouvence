...
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/molecule_in_pathway.parquet' ./
```
...
paths = fs.glob('jouvencekb/kg/v2/edges/molecule_in_pathway.parquet')
