...
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/mutation_causes_protein_change.parquet' ./
```
...
paths = fs.glob('jouvencekb/kg/v2/edges/mutation_causes_protein_change.parquet')
