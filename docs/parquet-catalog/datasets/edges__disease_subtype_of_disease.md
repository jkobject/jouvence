...
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/disease_subtype_of_disease.parquet' ./
```
...
paths = fs.glob('jouvencekb/kg/v2/edges/disease_subtype_of_disease.parquet')
