...
# `edges__enhancer_regulates_gene`

- Layer: `edges`
- Status: **canonical present**
- As of: `2026-06-15`
- Canonical URI/pattern: `gs://jouvencekb/kg/v2/edges/enhancer_regulates_gene.parquet`
- Logical rows: **48,808,144**
- Physical objects: **1**
- Bytes: **1,997,157,871**
- Schema hash (`arrow-fields-v1`): `b619587ee4f7bf9df888bf6a2506a2429369e8b640ac03020754fbf520a2933a`
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/kg/v2/edges/enhancer_regulates_gene.parquet` | 48,808,144 | 1,997,157,871 | `1781481654900481` | `MNF0ow==` | `wZPnYXmcbGyQfcAdGioZgw==` |
...
LOCAL_DIR='./parquet-catalog-data/edges__enhancer_regulates_gene'
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/enhancer_regulates_gene.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/kg/v2/edges/enhancer_regulates_gene.parquet'))
...
SELECT "x_id" FROM read_parquet('./parquet-catalog-data/edges__enhancer_regulates_gene/enhancer_regulates_gene.parquet') ORDER BY "x_id" NULLS LAST LIMIT 5;
```
