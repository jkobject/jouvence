...
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/phenotype_subtype_of_phenotype.parquet' ./
```
...
paths = fs.glob('jouvencekb/kg/v2/edges/phenotype_subtype_of_phenotype.parquet')
