...
# `edges__phenotype_subtype_of_phenotype`

- Layer: `edges`
- Status: **canonical present**
- As of: `2026-06-07`
- Canonical URI/pattern: `gs://jouvencekb/kg/v2/edges/phenotype_subtype_of_phenotype.parquet`
- Logical rows: **37,472**
- Physical objects: **1**
- Bytes: **266,843**
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/kg/v2/edges/phenotype_subtype_of_phenotype.parquet` | 37,472 | 266,843 | `1780837807126694` | `4PL6iA==` | `V5PLVbt3kn+RkoW2BHUmNg==` |
...
LOCAL_DIR='./parquet-catalog-data/edges__phenotype_subtype_of_phenotype'
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/phenotype_subtype_of_phenotype.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/kg/v2/edges/phenotype_subtype_of_phenotype.parquet'))
...
SELECT "x_id" FROM read_parquet('./parquet-catalog-data/edges__phenotype_subtype_of_phenotype/phenotype_subtype_of_phenotype.parquet') ORDER BY "x_id" NULLS LAST LIMIT 5;
```
