...
# `edges__pathway_contains_gene`

- Layer: `edges`
- Status: **canonical present**
- As of: `2026-06-18`
- Canonical URI/pattern: `gs://jouvencekb/kg/v2/edges/pathway_contains_gene.parquet`
- Logical rows: **630,932**
- Physical objects: **1**
- Bytes: **5,891,672**
- Schema hash (`arrow-fields-v1`): `6dd52ed43ba8b142cd26bff6e1c152be419f4f055308cf6dfc1b3bc1faf0b000`
...
| `go_evidence` | `string` | `true` |
| `go_aspect` | `string` | `true` |
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/kg/v2/edges/pathway_contains_gene.parquet` | 630,932 | 5,891,672 | `1781796931756900` | `Ufj+8Q==` | `0u5RhQGC7+c3lsllp4AM3g==` |
...
LOCAL_DIR='./parquet-catalog-data/edges__pathway_contains_gene'
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/pathway_contains_gene.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/kg/v2/edges/pathway_contains_gene.parquet'))
...
SELECT "x_id" FROM read_parquet('./parquet-catalog-data/edges__pathway_contains_gene/pathway_contains_gene.parquet') ORDER BY "x_id" NULLS LAST LIMIT 5;
```
