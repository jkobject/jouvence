...
- As of: `2026-06-18`
- Canonical URI/pattern: `gs://jouvencekb/kg/v2/edges/molecule_associated_phenotype.parquet`
- Logical rows: **64,784**
- Physical objects: **1**
- Bytes: **111,612**
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/kg/v2/edges/molecule_associated_phenotype.parquet` | 64,784 | 111,612 | `1781796935117381` | `pMESXg==` | `jDlMgFXi8mabZULz/sOQnQ==` |
...
LOCAL_DIR='./parquet-catalog-data/edges__molecule_associated_phenotype'
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/molecule_associated_phenotype.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/kg/v2/edges/molecule_associated_phenotype.parquet'))
...
SELECT "x_id" FROM read_parquet('./parquet-catalog-data/edges__molecule_associated_phenotype/molecule_associated_phenotype.parquet') ORDER BY "x_id" NULLS LAST LIMIT 5;
```
