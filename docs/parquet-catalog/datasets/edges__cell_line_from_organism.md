...
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/cell_line_from_organism.parquet' ./
```
...
paths = fs.glob('jouvencekb/kg/v2/edges/cell_line_from_organism.parquet')
