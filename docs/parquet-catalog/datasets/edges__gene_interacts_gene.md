...
- As of: `2026-06-18`
- Canonical URI/pattern: `gs://jouvencekb/kg/v2/edges/gene_interacts_gene.parquet`
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/kg/v2/edges/gene_interacts_gene.parquet` | 7,424,037 | 36,907,950 | `1781803599193107` | `uOngJA==` | `ToVuKhLC7KIly8SQwHZeHQ==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/gene_interacts_gene.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/kg/v2/edges/gene_interacts_gene.parquet'))
