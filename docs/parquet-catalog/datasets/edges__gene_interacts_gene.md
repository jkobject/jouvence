...
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/gene_interacts_gene.parquet' ./
```
...
paths = fs.glob('jouvencekb/kg/v2/edges/gene_interacts_gene.parquet')
