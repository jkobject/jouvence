...
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/mutation_associated_gene.parquet' ./
```
...
paths = fs.glob('jouvencekb/kg/v2/edges/mutation_associated_gene.parquet')
