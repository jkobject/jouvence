...
- As of: `2026-06-10`
- Canonical URI/pattern: `gs://jouvencekb/kg/v2/edges/mutation_associated_gene.parquet`
...
|---|---:|---:|---|---|---|
| `gs://jouvencekb/kg/v2/edges/mutation_associated_gene.parquet` | 535,093 | 22,829,668 | `1781115246447606` | `lrFdnQ==` | `lc6K2XGOY4lRgR92i0sHCQ==` |
...
rm -rf -- "$LOCAL_DIR"
mkdir -p "$LOCAL_DIR"
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/mutation_associated_gene.parquet' "$LOCAL_DIR/"
```
...
paths = sorted(fs.glob('jouvencekb/kg/v2/edges/mutation_associated_gene.parquet'))
