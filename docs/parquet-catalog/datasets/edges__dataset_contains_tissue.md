...
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/dataset_contains_tissue.parquet' ./
```
...
paths = fs.glob('jouvencekb/kg/v2/edges/dataset_contains_tissue.parquet')
