...
gcloud storage cp --billing-project="$BILLING_PROJECT" 'gs://jouvencekb/kg/v2/edges/tissue_expresses_protein.parquet' ./
```
...
paths = fs.glob('jouvencekb/kg/v2/edges/tissue_expresses_protein.parquet')
