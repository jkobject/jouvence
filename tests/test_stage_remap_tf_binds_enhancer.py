...
REQUIRED_SCRIPTS = [
    "stage_remap_tf_binds_enhancer.py",
    "stage_remap_tf_binds_enhancer_compact.py",
    "stage_remap_crm_tf_binds_enhancer_support.py",
]
missing_scripts = [name for name in REQUIRED_SCRIPTS if not (SCRIPTS / name).exists()]
if missing_scripts:
    pytest.skip(
        "historical ReMap stage implementations are not present in reviewable source: "
        + ", ".join(missing_scripts),
        allow_module_level=True,
    )

SCRIPT = SCRIPTS / "stage_remap_tf_binds_enhancer.py"
...
COMPACT_SCRIPT = SCRIPTS / "stage_remap_tf_binds_enhancer_compact.py"
...
CRM_SCRIPT = SCRIPTS / "stage_remap_crm_tf_binds_enhancer_support.py"
